...
class MeterRepository:
    ...
    def get_last_meter_values(
        ...
        stmt = (
            ...
            .join(MeterInstallation, MeterInstallation.meter == Meter.m_id)
            .join(InstallationLocation, MeterInstallation.installation_location == InstallationLocation.il_id)
            .join(Room, InstallationLocation.room == Room.r_id)
            .where(Room.connection == connection_id)
